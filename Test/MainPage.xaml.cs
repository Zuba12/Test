...
public partial class MainPage : ContentPage
{
    ...
    private async void SaveBtn_Clicked(object sender, EventArgs e)
    {
        try
        {
            string newFilePath = Path.Combine(Path.GetDirectoryName(path), "Upraveno" + Path.GetExtension(path));
            ...
            var formatter = new Upravovac(path);
            await formatter.FormatTextAsync();
